...
> 作者：苏剑林 · 科学空间 · 2014-12-18
>
> 原文：<https://spaces.ac.cn/archives/3134>
>
...
<strong>前言：</strong>一年前国赛的时候，很初级地做了一下B题，做完之后还写了个《碎纸复原：一个人的数学建模》。当时就是对题目很有兴趣，然后通过一天的学习，基本完成了附件一二的代码，对附件三也只是有个概念。而今年我们上的数学建模课，老师把这道题作为大作业让我们做，于是我便再拾起了一年前的那份激情，继续那未完成的一个人的数学建模\.\.\.
...
[![相邻的碎纸片](<https://spaces.ac.cn/usr/uploads/2014/12/2472439939.png>)](<https://spaces.ac.cn/usr/uploads/2014/12/2472439939.png>)
...
[![附件三的初步拼接](<https://spaces.ac.cn/usr/uploads/2014/12/3322048331.png>)](<https://spaces.ac.cn/usr/uploads/2014/12/3322048331.png>)
...
<pre><code class="language-python">known[14] = [128, 3, 159, 82, 199]
known[7] = [208]
...
<pre><code class="language-python">impossible[199] = [7]
impossible[208] = [29]
impossible[75] = [38]
...
</code></pre>
...
for i in xulie:
    ...
    j=j+1
comb_img.show()</code></pre>



<strong>附件3和4的代码</strong>
