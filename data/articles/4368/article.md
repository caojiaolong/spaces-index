...
> 作者：苏剑林 · 科学空间 · 2017-05-01
>
> 原文：<https://spaces.ac.cn/archives/4368>
>
...
有了这个相似度概念，我们既可以比较任意两个词之间的相似度，也可以找出跟给定词最相近的词语。这在gensim的Word2Vec中，由most\_similar函数实现。
...
> 
> 
> \>\>\> pd\.Series(model\.most\_similar(s))
> 0 (东莞, 0\.840889930725)
> 1 (深圳, 0\.799216389656)
> 2 (佛山, 0\.786817014217)
> 3 (惠州, 0\.779960155487)
...
def relative_words(word):
    ...
    return Counter(r).most_common()</code></pre>
