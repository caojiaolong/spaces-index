...
>
> 原文：<https://spaces.ac.cn/archives/3854>
>
...
衡量OCR系统的好坏有两部分内容：<u>(1)是否成功地圈出了文字；(2)对于圈出来的文字，有没有成功识别\.</u> 我们采用评分的方法，对每一张图片的识别效果进行评分\. 评分规则如下：
...
经过测试，我们的系统对印刷文字的识别有着不错的效果，可以作为电商、微信等平台的图片文字识别工具\. 其中明显的特点是，<strong>我们的系统可以将整张文字图片输入，并且在分辨率不高的情况下能够获得较好的效果\.</strong>
