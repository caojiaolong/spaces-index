...
> 作者：苏剑林 · 科学空间 · 2021-10-18
>
> 原文：<https://spaces.ac.cn/archives/8725>
>
...
在[《从几何视角来理解模型参数的初始化策略》](<https://spaces.ac.cn/archives/7180>)、[《浅谈Transformer的初始化、参数化与标准化》](<https://spaces.ac.cn/archives/8620>)等文章，我们讨论过模型的初始化方法，大致的思路是：如果一个$n\times n$的方阵用均值为0、方差为$1/n$的独立同分布初始化，那么近似于一个正交矩阵，使得数据二阶矩（或方差）在传播过程中大致保持不变。
...
其中$b_j$一般初始化为0，$w_{i,j}$的初始化均值一般也为0，在[《浅谈Transformer的初始化、参数化与标准化》](<https://spaces.ac.cn/archives/8620>)中我们已经算得
\begin{equation}
