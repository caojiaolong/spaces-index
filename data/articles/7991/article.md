...
> 作者：苏剑林 · 科学空间 · 2020-12-14
>
> 原文：<https://spaces.ac.cn/archives/7991>
>
...
知道IEEE754表示法之后，就可以理解上述代码了，<code>*(int*)&amp;a</code>和<code>*(int*)&amp;b</code>其实就是把$a,b$的IEEE754表示拿出来，当作普通的整数来运算，两者相加，其实正好对应着Mitchell近似对数后的相加结果，但是指数部分会多出一个偏移量，所以要减去整个偏移量，由于偏移量是127，并且后面还有23位，所以减去偏移量相当于减去常数$127\times 2^{23}$，表示为十六进制就是3f800000（因为二进制表示太长了，所以计算机一般用十六进制来代替二进制进行IO），最后将加减后的结果恢复为浮点数。
...
[![近似程度的等高线图。可以看出最小的近似程度应该在中心点处。](<https://spaces.ac.cn/usr/uploads/2020/12/2873724682.png>)](<https://spaces.ac.cn/usr/uploads/2020/12/2873724682.png>)
