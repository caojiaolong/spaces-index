...
> 作者：苏剑林 · 科学空间 · 2014-08-19
>
> 原文：<https://spaces.ac.cn/archives/2831>
>
...
<strong>5\.1、</strong>假如$\varepsilon_1=i,\varepsilon_2=-i$，那么
...
<strong>5\.2、</strong>假如$\varepsilon_1=-i,\varepsilon_2=i$，那么
$$-i y^2=-i \kappa^4-i\iota^4$$
也就是
$$y^2=\kappa^4+\iota^4$$
...
<strong>5\.3、</strong>假如$\varepsilon_1=-1,\varepsilon_2=-1$，那么
...
<strong>5\.4、</strong>假如$\varepsilon_1=1,\varepsilon_2=1$，那么
$$-i y^2=\kappa^4-\iota^4$$
分析跟5\.3基本一样，也导出矛盾。
...
<strong>可以直接证明$\varepsilon x^4+y^4=z^2,\ \xi|x$无解，从而简化证明过程，参考[下一篇文章](<https://spaces.ac.cn/archives/2858/>)。将下一篇文章的步骤稍微修改一下即可。</strong>
