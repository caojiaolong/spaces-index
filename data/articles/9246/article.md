...
> 作者：苏剑林 · 科学空间 · 2022-08-18
>
> 原文：<https://spaces.ac.cn/archives/9246>
>
...
在上一篇文章[《生成扩散模型漫谈（七）：最优扩散方差估计（上）》](<https://spaces.ac.cn/archives/9245>)中，我们介绍并推导了Analytic\-DPM中的扩散模型最优方差估计结果，它是直接给出了已经训练好的生成扩散模型的最优方差的一个解析估计，实验显示该估计结果确实能有效提高扩散模型的生成质量。
...
其中$\bar{\sigma}_t^2$是分布$p(\boldsymbol{x}_0|\boldsymbol{x}_t)$的方差，它有如下的估计结果（这里取“[方差估计2](<https://spaces.ac.cn/archives/9245#%E6%96%B9%E5%B7%AE%E4%BC%B0%E8%AE%A12>)”的结果）：
